...
class EventClass(set, Enum):
    ...
    _CGM_START = {events.LidCgmStartSessionGx, events.LidCgmStartSessionFsl2, events.LidCgmStartSessionFsl3}
    ...
    _CGM_STOP = {events.LidCgmStopSessionGx, events.LidCgmStopSessionG7, events.LidCgmStopSessionFsl2}  # events.LidCgmStopSessionFsl3 - TBD, no data yet
